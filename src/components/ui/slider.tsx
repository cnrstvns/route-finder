...
const Slider = ({ onChange }: SliderProps) => {
	...
	return (
		...
		>
			...
			<SliderPrimitive.Thumb className="block group pointer hover:shadow-md h-5 w-5 rounded-full border border-neutral-200 bg-white active:border-neutral-300 focus:outline-none transition-all duration-200 disabled:pointer-events-none disabled:opacity-50">
			...
			<SliderPrimitive.Thumb className="block group hover:shadow-md h-5 w-5 rounded-full border border-neutral-200 bg-white active:border-neutral-300 focus:outline-none transition-all duration-200 disabled:pointer-events-none disabled:opacity-50">
				<span className="absolute z-10 group-active:z-20 border px-2 py-0.5 border-transparent group-active:rounded-md group-active:bg-neutral-50 group-active:border-neutral-200 group-active:border top-6 w-max -translate-x-[calc(50%-10px)] text-sm text-neutral-600">
					{maxValue / 60} hours
				</span>
			</SliderPrimitive.Thumb>
